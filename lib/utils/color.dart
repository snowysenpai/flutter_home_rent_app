...
class AppColors {
  ...
  static const Color primaryColor = Color(0xff244cb3);
  ...
  static const Color textPrimary = Color(0xff244cb3);
  ...
  static const Color Black = Color(0xffF3F4F4);
  static const Color iconbg = Color(0xfff3f6fb);
